...
namespace SHMS.Controllers
{
    public class PrescriptionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PrescriptionId,PatientId,DoctorId,PrescriptionDate,Notes")] Prescription prescription)
        {
            ...
            ViewData["DoctorId"] = new SelectList(_context.Doctors, "DoctorId", "Email", prescription.DoctorId);
            ViewData["PatientId"] = new SelectList(_context.Patients, "PatientId", "Gender", prescription.PatientId);
            return View(prescription);
        }
